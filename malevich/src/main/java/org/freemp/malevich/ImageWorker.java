...
public class ImageWorker {
     ...
     */
    public void loadImage(Object data, ImageView imageView, String uniqueCacheKey, int reqWidth, int reqHeight, Malevich.ImageDecodedListener imageDecodedListener) {
        if (data == null) {
            return;
        }
        ...
        if (value == null && mImageCache != null) {
            value = mImageCache.getBitmapFromMemCache(String.valueOf(data)+"#width"+reqWidth+"#height"+reqHeight+"#uniqueCacheKey"+uniqueCacheKey);
        }
